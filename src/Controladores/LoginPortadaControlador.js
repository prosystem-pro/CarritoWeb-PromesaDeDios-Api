const Servicio = require('../Servicios/LoginPortadaServicio');
...
const Listado = async (req, res) => {
  try {
    ...
    return ResponderExito(res, 'Listado exitoso', Objeto || []);
  } catch (error) {
...
const ObtenerPorCodigo = async (req, res) => {
  try {
    ...
    return ResponderExito(res, 'Registro encontrado', Objeto);
  } catch (error) {
...
const Buscar = async (req, res) => {
  try {
    ...
    return ResponderExito(res, 'Búsqueda exitosa', Objeto);
  } catch (error) {
