const Servicio = require('../Servicios/ReporteProductoServicio');
...
const ObtenerResumen = async (req, res) => {
  try {
    ...
    const topProductos = await Servicio.ObtenerResumen(anio, mes);
    return ResponderExito(res, 'Resumen obtenido correctamente', topProductos);
  } catch (error) {
