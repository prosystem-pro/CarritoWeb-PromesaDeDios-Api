...
const Modelo = 'contactanosportada';
const Tabla = 'ContactanosPortada'
const { Listado, ObtenerPorCodigo, Buscar, Crear, Editar, Eliminar } = require('../Controladores/ContactanosPortadaControlador');
